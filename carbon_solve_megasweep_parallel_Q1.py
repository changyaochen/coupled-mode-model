...
def process_input(para):
    ...
    # ==============================================================
    Q1 = para
    temp_folder = 'PythonParallelTemp_Q1'
...
def main():
    ...
    with open('combined_Q1.txt', 'a') as outfile:
        for para in para_list:
            with open(os.path.join(os.getcwd(),'PythonParallelTemp_Q1') + '/' +str(para)+'.txt', 'r') as infile:
