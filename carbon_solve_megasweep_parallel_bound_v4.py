...
def process_input(para):
    ...
    # ==============================================================
    bound = para
    temp_folder = 'PythonParallelTemp_bound_v4'
...
def main():
    ...
    with open('combined_bound_v4.txt', 'a') as outfile:
        for para in para_list:
            with open(os.path.join(os.getcwd(),'PythonParallelTemp_bound_v4') + '/' +str(para)+'.txt', 'r') as infile:
