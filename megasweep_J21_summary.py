...
def main():
    ...
    #filename = filepath + 'test_mega_steady_state_J21.txt'
    filename = filepath + 'combined_J21_fine_v2.txt'
    ...
    mega_plot(mode1)
    prettify_figure('Frequency', 'J21', 'mode 1, steady-state')
    
    mode2 = mega2matrix(raw_data[:,[0,2,-1]])
    mega_plot(mode2)
    prettify_figure('Frequency', 'J21', 'mode 2, steady-state')
    ...
    prettify_figure('side-band frequency', 'J21')
    plt.show()
