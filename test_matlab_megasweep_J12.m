...
figure(1);
megaPlot(mode_1, '');
prettifyPlot('Frequency (a.u.)','parameter = J12',' Mode 1');
ylim([1.08, 1.12]);
set(gca,'xscale','log');
...
colormap jet;
megaPlot(mode_1_log, '');
prettifyPlot('Frequency (a.u.)','parameter = J12','Mode 1, log');
ylim([1.08, 1.12]);
set(gca,'xscale','log');
...
figure(2);
megaPlot(mode_2, '');
prettifyPlot('Frequency (a.u.)','parameter = J12',' Mode 2');
ylim([1.08, 1.12]);
set(gca,'xscale','log');
...
colormap jet;
megaPlot(mode_2_log, '');
prettifyPlot('Frequency (a.u.)','parameter = J12',' Mode 2, log');
ylim([1.08, 1.12]);
set(gca,'xscale','log');
...
prettifyPlot('Beat frequency (a.u.)', 'parameter = J12 (a.u.)','');
