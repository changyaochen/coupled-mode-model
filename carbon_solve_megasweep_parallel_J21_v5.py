...
def process_input(para):
    ...
    # ==============================================================
    J21 = para
    temp_folder = 'PythonParallelTemp_J21_v5'
    if not os.path.exists(temp_folder):
            os.makedirs(temp_folder)
    temp_file = os.path.join(os.getcwd(),temp_folder) + '/ss_J21_' + str(para) + '.png' 
    # ==============================================================
    # ============================================================== 
    ...
    #plt.show()
    plt.savefig(os.path.join(os.getcwd(),temp_folder) + '/ss_FFT_J21_' + str(para) + '.png')
    ...
    temp_file_2 = os.path.join(os.getcwd(),temp_folder) + '/rd_J21_' + str(para) + '.png' 
    ...
    plt.ylim([1.0, 1.1])
    plt.yscale('linear')
    plt.savefig(os.path.join(os.getcwd(),temp_folder) + '/RTSA_mode1_J21_' + str(para) + '.png', dpi = 400)
    
    RTSA(time, Ringdown[:,2], 200)
    prettify_figure('Frequency', 'time', 'real-time spectrum, ringdown, mode 2')
    plt.ylim([1.0, 1.1])  
    plt.yscale('linear')  
    plt.savefig(os.path.join(os.getcwd(),temp_folder) + '/RTSA_mode2_J21_' + str(para) + '.png', dpi = 400)
