...
def process_input(para):
    ...
    # ==============================================================
    Q2 = para
    temp_folder = 'PythonParallelTemp_Q2'
...
def main():
    ...
    with open('combined_Q2.txt', 'a') as outfile:
        for para in para_list:
            with open(os.path.join(os.getcwd(),'PythonParallelTemp_Q2') + '/' +str(para)+'.txt', 'r') as infile:
