...
#    print('='*50)
    ...
    temp_folder = 'PythonParallelTemp_NMM_1_to_3_f0'
    if not os.path.exists(temp_folder):
            os.makedirs(temp_folder)
    temp_file = os.path.join(os.getcwd(),temp_folder) + '/ss_f0_' + str(para) + '.png' 
    # ==============================================================
    # ============================================================== 
    ...
    if doPlot:    
      ...
      #plt.show()
      plt.savefig(os.path.join(os.getcwd(),temp_folder) + '/ss_FFT_f0_' + str(para) + '.png')
    ...
    if doPlot:
      ...
      temp_file_2 = os.path.join(os.getcwd(),temp_folder) + '/rd_f0_' + str(para) + '.png' 
    ...
    if save_file == 1:
        np.savetxt(os.path.join(os.getcwd(),temp_folder) + '/rd_f0_' + str(para) + '.txt'
    ...
    if doRTSA:
      ...
      plt.ylim([1.0, 1.1])
      plt.yscale('linear')
      plt.savefig(os.path.join(os.getcwd(),temp_folder) + '/RTSA_mode1_f0_' + str(para) + '.png', dpi = 400)
      
      RTSA(time, Ringdown[:,2], 200)
      prettify_figure('Frequency', 'time', 'real-time spectrum, ringdown, mode 2')
      plt.ylim([1.0, 1.1])  
      plt.yscale('linear')  
      plt.savefig(os.path.join(os.getcwd(),temp_folder) + '/RTSA_mode2_f0_' + str(para) + '.png', dpi = 400)
